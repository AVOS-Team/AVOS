...
namespace AVOS.System64.Graphics
{
    class Files
    {
        ...
        [ManifestResourceStream(ResourceName = "AVOS.System64.Graphics.Wallpapers.Wall4.bmp")] public static byte[] AVOSBackround4Raw;
        [ManifestResourceStream(ResourceName = "AVOS.System64.Graphics.Wallpapers.Wall4S.bmp")] public static byte[] AVOSBackround4SRaw;
